...
function createBattleStatsString(battlereports) {
  ...
  text += '\n' + createAmountAverageDeviationString(stats.reward, 'Rewards', emoji.gold)
  text += '\n' + createAmountAverageDeviationString(stats.rewardAlliance, 'Alliance Battles', emoji.gold)

  text += '\n'
  text += '\n' + createAmountAverageDeviationString(stats.rewardAttackWon, 'Successful Attacks', emoji.gold)
  text += '\n' + createAmountAverageDeviationString(stats.rewardDefenseWon, 'Successful Defenses', emoji.gold)
  text += '\n' + createAmountAverageDeviationString(stats.rewardAttackLost, 'Lost Attacks', emoji.gold)
  text += '\n' + createAmountAverageDeviationString(stats.rewardDefenseLost, 'Lost Defenses', emoji.gold)

  text += '\n'
  text += '\n' + createAmountAverageDeviationString(stats.karma, 'Karma', emoji.karma)
  text += '\n' + createAmountAverageDeviationString(stats.terra, 'Terra', emoji.terra)

  text += '\n'
  text += '\n' + createAmountAverageDeviationString(stats.rewardDragon, 'Dragon', emoji.gold)
  text += '\n' + createAmountAverageDeviationString(stats.rewardUndead, 'Undead', emoji.gold)

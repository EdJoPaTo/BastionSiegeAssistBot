...
const {createAmountAverageDeviationString, createAverageMaxString} = require('../lib/number-function-strings')
...
function createPlayerStatsString(allBattlereports, stats) {
  ...
  text += '\n' + createAverageMaxString(stats.loot, 'Loot', emoji.gold)
  if (stats.gems.amount > 0) {
    text += '\n' + createAverageMaxString(stats.gems, 'Gems', emoji.gem)
  }

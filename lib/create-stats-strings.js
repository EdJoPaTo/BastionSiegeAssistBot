...
const {createAmountAverageDeviationString} = require('../lib/number-function-strings')
...
function createBattleStatsString(battlereports) {
  ...
  text += '\n' + createAmountAverageDeviationString(stats.reward, 'Rewards', emoji.gold, true)
  text += '\n' + createAmountAverageDeviationString(stats.rewardAlliance, 'Alliance Battles', emoji.gold, true)

  text += '\n'
  text += '\n' + createAmountAverageDeviationString(stats.rewardAttackWon, 'Successful Attacks', emoji.gold, true)
  text += '\n' + createAmountAverageDeviationString(stats.rewardDefenseWon, 'Successful Defenses', emoji.gold, true)
  text += '\n' + createAmountAverageDeviationString(stats.rewardAttackLost, 'Lost Attacks', emoji.gold, true)
  text += '\n' + createAmountAverageDeviationString(stats.rewardDefenseLost, 'Lost Defenses', emoji.gold, true)

  text += '\n'
  text += '\n' + createAmountAverageDeviationString(stats.karma, 'Karma', emoji.karma, true)
  text += '\n' + createAmountAverageDeviationString(stats.terra, 'Terra', emoji.terra, true)

  text += '\n'
  text += '\n' + createAmountAverageDeviationString(stats.rewardDragon, 'Dragon', emoji.gold, true)
  text += '\n' + createAmountAverageDeviationString(stats.rewardUndead, 'Undead', emoji.gold, true)
  text += '\n' + createAmountAverageDeviationString(stats.gems, 'Gems', emoji.gem, true)
...
function createPlayerStatsString(allBattlereports, stats) {
  ...
  text += '\n' + createAmountAverageDeviationString(stats.loot, 'Loot', emoji.gold)
  if (stats.gems.amount > 0) {
    text += '\n' + createAmountAverageDeviationString(stats.gems, 'Gems', emoji.gem)
  }

...
function createFillTimeStatsString(buildings, resources) {
  ...
  const estimatedRessourcedWhenFillAvailable = estimateResourcesAfterTimespan(resources, buildings.townhall, buildings.storage, buildings.houses, buildings.sawmill, buildings.mine, buildings.farm, minutesNeededToFillStorage)

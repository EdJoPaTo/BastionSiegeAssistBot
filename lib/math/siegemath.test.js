...
test('building cost per winning chance example', t => {
  t.deepEqual(calcBuildingCostPerWinchanceSolo('barracks', 1), {gold: 1500, wood: 750, stone: 750})
  t.deepEqual(calcBuildingCostPerWinchanceAlliance('barracks', 1), {gold: 15000, wood: 7500, stone: 7500})
})

...
test('max building level', t => {
  t.is(calcMaxBuildingLevel('trebuchet', {townhall: 21, storage: 1000}), 50)
  t.is(calcMaxBuildingLevel('trebuchet', {townhall: 81, storage: 1000}), 100)
  t.is(calcMaxBuildingLevel('trebuchet', {townhall: 502, storage: 1000}), 250)
  t.is(calcMaxBuildingLevel('townhall', {townhall: 1000, storage: 3}), 5)
  t.is(calcMaxBuildingLevel('townhall', {townhall: 1000, storage: 8}), 10)
  t.is(calcMaxBuildingLevel('townhall', {townhall: 1000, storage: 63}), 50)
})
...
test('building cost per winning chance trebuchet', t => {
  ...
  t.deepEqual(calcBuildingCostPerWinchanceSolo('trebuchet', 1).gold, goldRequired)
})
...
test('building cost per winning chance barracks solo', t => {
  ...
  t.deepEqual(calcBuildingCostPerWinchanceSolo('barracks', 1).gold, goldRequired)
})
...
test('building cost per winning chance barracks alliance', t => {
  ...
  t.deepEqual(calcBuildingCostPerWinchanceAlliance('barracks', 1).gold, goldRequired)
})

...
function calcMinutesNeededToFillStorage(buildings, currentResources) {
  ...
  console.log('calcMinutesNeededToFillStorage', minutesNeeded, combinedMinutesNeededFirstApprox, buildings, currentResources)
  console.log('info', combinedNeed, combinedIncome)
  console.log('only', onlyWoodNeededMinutes, onlyStoneNeededMinutes, onlyFoodNeededMinutes)

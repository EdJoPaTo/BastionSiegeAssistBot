...
function createBattleStatsString(stats) {
  ...
  text += createAlliancesStats(stats.mystics, 'Mystics', emoji.gold, true)
  text += '\n' + createAverageSumString(stats.gems, 'Gems', emoji.gem, true)

  text += createAlliancesStats(stats.rewardAttackWon, 'Successful Attacks', emoji.gold, true)
  text += createAlliancesStats(stats.rewardDefenseWon, 'Successful Defenses', emoji.gold, true)
  text += createAlliancesStats(stats.rewardAttackLost, 'Lost Attacks', emoji.gold, true)
  text += createAlliancesStats(stats.rewardDefenseLost, 'Lost Defenses', emoji.gold, true)
